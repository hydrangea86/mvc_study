        ...
        <div class="modify-container">
            ...
            <form action="/board/modify" method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="제목" name="title" value="${b.title}">
                </div>
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-dark" type="submit">글 수정하기</button>
